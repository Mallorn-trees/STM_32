...
//电阻屏芯片连接引脚	   
#define PEN      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_1)      //PB1--TPEN
#define DOUT     HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_2)     	//PB2--T-MISO
#define TDIN(x)  HAL_GPIO_WritePin(GPIOF,GPIO_PIN_11, x);  //PF11--T-MOSI
#define TCLK(x)  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0, x); //PB0--TSCK
#define TCS(x)   HAL_GPIO_WritePin(GPIOC,GPIO_PIN_13,x);  //PC13 CS 
